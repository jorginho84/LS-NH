...
save "$results/data_emp.dta", replace
...
gen mean_aux1=emp if p_assign=="E" & pvalues1<=0.05

*Number of obs=745 for quarter>=-3 & quarter<=32


 twoway (line emp quarter if p_assign=="E" & quarter>=-3 & quarter<=32, lpattern(solid) lwidth(thick) ) /*
 */ (scatter mean_aux1 quarter if p_assign=="E" & quarter>=-3 & quarter<=32,  msymbol(circle) mcolor(blue) mfcolor(blue) msize(medlarge) mlwidth(medthick)) /*
*/ (line emp quarter if p_assign=="C" &  quarter>=-3 & quarter<=32, lpattern(dash) lwidth(thick)),/*
...
if `csj'==0{
	graph export "$results/LS_admin_qra_level_NoCSJ.pdf", as(pdf) replace
}

else{
	graph export "$results/LS_admin_qra_level.pdf", as(pdf) replace
}
...
gen mean_aux1_0=emp if p_assign=="E" & pvalues_01<=0.05 & d_young==0
gen mean_aux1_1=emp if p_assign=="E" & pvalues_11<=0.05 & d_young==1

twoway (line emp quarter if p_assign=="E" & quarter>=-3 & quarter<=32 & d_young==0, lwidth(thick)) /*
*/ (scatter mean_aux1_0 quarter if p_assign=="E" & quarter>=-3 & quarter<=32 & d_young==0,  msymbol(circle) mcolor(blue) mfcolor(blue) msize(medlarge) mlwidth(medthick)) /*
*/(line emp quarter if p_assign=="C" & quarter>=-3 & quarter<=32 & d_young==0,  lpattern(dash) lwidth(thick)),/*
*/scheme(s2mono) legend(order(1 "Treatment" 5 "Control")  )/*
*/ytitle(Employment (in%)) xtitle(Quarters since RA)/*
*/graphregion(fcolor(white) ifcolor(white) lcolor(white) ilcolor(white)) plotregion(fcolor(white) lcolor(white)  ifcolor(white) ilcolor(white)) /*
*/ ylabel(, nogrid) ylabel(30(10)100) /*
...
if `csj'==0{
	graph export "$results/LS_admin_qra_level_old_NoCSJ.pdf", as(pdf) replace
}
else{
	graph export "$results/LS_admin_qra_level_old.pdf", as(pdf) replace
}
twoway (line emp quarter if p_assign=="E" & quarter>=-3 & quarter<=32 & d_young==1, lpattern(solid) lwidth(thick) ) /*
*/ (scatter mean_aux1_1 quarter if p_assign=="E" & quarter>=-3 & quarter<=32 & d_young==1,  msymbol(circle) mcolor(blue) mfcolor(blue) msize(medlarge) mlwidth(medthick)) /*
*/(line emp quarter if p_assign=="C" & quarter>=-3 & quarter<=32 & d_young==1,  lpattern(dash) lwidth(thick)),/*
*/scheme(s2mono) legend(order(1 "Treatment" 5 "Control")  )/*
*/ytitle(Employment (in%)) xtitle(Quarters since RA)/*
*/graphregion(fcolor(white) ifcolor(white) lcolor(white) ilcolor(white)) plotregion(fcolor(white) lcolor(white)  ifcolor(white) ilcolor(white)) /*
*/ ylabel(, nogrid) ylabel(30(10)100)  /*
...
if `csj'==0{
	graph export "$results/LS_admin_qra_level_young_NoCSJ.pdf", as(pdf) replace
}
