...
class Prod2(Utility):
	...
	def elec(self):
		...
		"""
		ec = np.load('/home/jrodriguez/understanding_NH/results/Model/experiments/NH/ec.npy')
		el = np.load('/home/jrodriguez/understanding_NH/results/Model/experiments/NH/el.npy')
		ecc = np.load('/home/jrodriguez/understanding_NH/results/Model/experiments/NH/el.npy')
		e_age = np.load('/home/jrodriguez/understanding_NH/results/Model/experiments/NH/e_age.npy')
