...
#Opening workbook
wb=openpyxl.load_workbook('/home/jrodriguez/understanding_NH/results/Model/fit/fit.xlsx')
...
plt.show()
fig.savefig('/home/jrodriguez/understanding_NH/results/Model/fit/fit_utility.pdf', format='pdf')
plt.close()
...
ax.set_xticks([])
plt.show()
fig.savefig('/home/jrodriguez/understanding_NH/results/Model/fit/fit_wage.pdf', format='pdf')
plt.close()
...
ax.set_xticks([])
plt.show()
fig.savefig('/home/jrodriguez/understanding_NH/results/Model/fit/fit_kappas.pdf', format='pdf')
plt.close()
...
ax.set_xticks([])
plt.show()
fig.savefig('/home/jrodriguez/understanding_NH/results/Model/fit/fit_ssrs.pdf', format='pdf')
plt.close()


	
wb.save('/home/jrodriguez/understanding_NH/results/Model/fit/fit.xlsx')
