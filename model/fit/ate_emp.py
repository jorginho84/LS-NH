...
subprocess.call(cmd)
ate_part_obs=pd.read_csv('/home/jrodriguez/understanding_NH/results/Model/fit/ate_part.csv').values
se_ate_part_obs=pd.read_csv('/home/jrodriguez/understanding_NH/results/Model/fit/se_ate_part.csv').values
ate_full_obs=pd.read_csv('/home/jrodriguez/understanding_NH/results/Model/fit/ate_full.csv').values
se_ate_full_obs=pd.read_csv('/home/jrodriguez/understanding_NH/results/Model/fit/se_ate_full.csv').values
ate_hours_obs=pd.read_csv('/home/jrodriguez/understanding_NH/results/Model/fit/ate_hours.csv').values
se_ate_hours_obs=pd.read_csv('/home/jrodriguez/understanding_NH/results/Model/fit/se_ate_hours.csv').values
...
for j in range(3):
	...
	plt.show()
	fig.savefig('/home/jrodriguez/understanding_NH/results/Model/fit/ate_' + graph_list[j] +'.pdf', format='pdf')
	plt.close()
