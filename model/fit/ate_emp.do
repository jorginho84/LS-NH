...
keep d_part_t0 d_part_t1 d_full_t0 d_full_t1 hours_t0 hours_t1 d_RA child_id age_t2
...
foreach vars in part full hours{
	...
	*For each year
	...
	set obs 9
	svmat ate_`vars'
	outsheet using "/home/jrodriguez/understanding_NH/results/Model/fit/ate_`vars'.csv", comma replace
	restore
	...
	set obs 9
	svmat se_ate_`vars'
	outsheet using "/home/jrodriguez/understanding_NH/results/Model/fit/se_ate_`vars'.csv", comma replace
	restore
	...
	*Before/after
	...
	set obs 1
	svmat ate_`vars'_2
	outsheet using "/home/jrodriguez/understanding_NH/results/Model/fit/ate_`vars'_2.csv", comma replace
	restore
	...
	outsheet using "/home/jrodriguez/understanding_NH/results/Model/fit/se_ate_`vars'_2.csv", comma replace
	restore
