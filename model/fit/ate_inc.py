...
#data
dofile = "/home/jrodriguez/understanding_NH/codes/model/fit/ate_inc.do"
cmd = ["stata-se", "do", dofile]
subprocess.call(cmd)
ate_inc_obs=pd.read_csv('/home/jrodriguez/understanding_NH/results/Model/fit/ate_inc_2.csv').values
se_ate_inc_obs=pd.read_csv('/home/jrodriguez/understanding_NH/results/Model/fit/se_ate_inc_2.csv').values
...
plt.show()
fig.savefig('/home/jrodriguez/understanding_NH/results/Model/fit/ate_income.pdf', format='pdf')
plt.close()
...
plt.yticks(fontsize=15)
plt.show()
fig.savefig('/home/jrodriguez/understanding_NH/results/Model/fit/ate_bars_income.pdf', format='pdf')
plt.close()