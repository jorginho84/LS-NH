...
*Before
preserve
keep incomepc_t1 d_RA child_id agech_t2
...
set obs 3
svmat ate_inc
outsheet using "/home/jrodriguez/understanding_NH/results/Model/fit/ate_inc.csv", comma replace
restore
...
set obs 3
svmat se_ate_inc
outsheet using "/home/jrodriguez/understanding_NH/results/Model/fit/se_ate_inc.csv", comma replace
restore
...
set obs 1
svmat ate_inc_2
outsheet using "/home/jrodriguez/understanding_NH/results/Model/fit/ate_inc_2.csv", comma replace
restore
...
set obs 1
svmat se_ate_inc_2
outsheet using "/home/jrodriguez/understanding_NH/results/Model/fit/se_ate_inc_2.csv", comma replace
restore
