...
global results "/home/jrodriguez/understanding_NH/results/Model/aux_model"
global codes "/home/jrodriguez/understanding_NH/codes/model/aux_model" /*this is where I compute aux moments*/
...
keep betas_orig1
drop if betas_orig1==.
outsheet using "$results/moments_vector.csv", comma  replace
restore
...
drop draw betas*
svmat var_cov
outsheet using "$results/var_cov.csv", comma  replace
restore
